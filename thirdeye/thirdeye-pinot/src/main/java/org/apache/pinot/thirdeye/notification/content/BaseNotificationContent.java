...
public abstract class BaseNotificationContent implements NotificationContent {
	...
	public static String makeSubject(AlertConfigBean.SubjectType subjectType,
			DetectionAlertConfigDTO notificationConfig, Map<String, Object> templateData) {
	...
	protected static String getFormattedSLALiftValue(MergedAnomalyResultDTO anomaly) {
		...
		long delayInMillis = anomaly.getEndTime()
				- Long.parseLong(anomaly.getProperties().get("datasetLastRefreshTime"));
	...
	public static class AnomalyReportEntity {
		...
		public AnomalyReportEntity(String anomalyId, String anomalyURL, String baselineVal, String currentVal,
				String lift, boolean positiveLift, Double swi, List<String> dimensions, String duration,
				String feedback, String function, String funcDescription, String metric, String startTime,
				String endTime, String timezone, String issueType, String anomalyType, String properties,
				String metricUrn) {
